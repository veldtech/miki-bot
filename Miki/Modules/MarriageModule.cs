...
namespace Miki.Modules
{
	...
	public class MarriageModule
    {
        ...
        public async Task CancelMarriageAsync(CommandContext e)
        {
            var context = e.GetService<MikiDbContext>();
            MarriageRepository repository = new MarriageRepository(context);
            ...
            else
            {
                ...
                await BuildMarriageEmbedAsync(embed, e.Author.Id.ToDbLong(), marriages);
		...
		public async Task DeclineMarriageAsync(CommandContext e)
		{
            var context = e.GetService<MikiDbContext>();
        ...
        public async Task DivorceAsync(CommandContext e)
        {
            var context = e.GetService<MikiDbContext>();
        ...
        public async Task ShowProposalsAsync(CommandContext e)
        {
